...
public class InventoryReport extends JFrame {
	...
	public InventoryReport(ArrayList<Pet> animals) {
		...
		for (int i = 0; i < animals.size(); i++) {
			...
			data[i][1] = animals.get(i).getCage();
		}
		...
		lblInventoryReport.setBounds(333, 39, 128, 31);
		getContentPane().add(lblInventoryReport);
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(38, 104, 759, 360);
		getContentPane().add(scrollPane);
		String[] columnNames = {"Animal Name", "Animal Cage #"};
