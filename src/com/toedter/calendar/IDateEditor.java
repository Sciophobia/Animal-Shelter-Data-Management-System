...
public interface IDateEditor {
	 ...
	 *
	 * @param min the minimum selectable date or null (then the minimum date should be
	 *            set to 01\01\0001)
	 * @param max the maximum selectable date or null (then the maximum date should be
	 *            set to 01\01\9999)
	 */
